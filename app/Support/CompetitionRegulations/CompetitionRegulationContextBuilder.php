    ...
    public function build(Competition $competition, string $locale): array
    {
        ...
        return [
            'competition' => [
                ...
                'registration_required' => $competition->registration_required,
                'registration_document_min' => $competition->registration_document_min,
                'registration_reviewer' => $competition->registration_reviewer,
