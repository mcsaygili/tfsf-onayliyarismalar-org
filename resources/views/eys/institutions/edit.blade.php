<x-eys.app-layout :title="__('eys.institution.edit_title')">
    <div class="ip-page-actions" style="justify-content: space-between;">
        <x-eys.breadcrumb :crumbs="[
            ...
            ['label' => __('eys.institution.edit_title')],
        ]" />
    ...
    <form method="POST" action="{{ route('eys.institutions.update', $institution) }}" novalidate autocomplete="off">
        @csrf
        @method('PATCH')
