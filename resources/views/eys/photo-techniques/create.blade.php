<x-eys.app-layout :title="__('eys.photo_technique.new')">
    <div class="ip-page-actions" style="justify-content: space-between;">
        <x-eys.breadcrumb :crumbs="[
            ...
            ['label' => __('eys.photo_technique.new')],
        ]" />
    ...
    <form method="POST" action="{{ route('eys.photo-techniques.store') }}" novalidate autocomplete="off">
        @csrf

        @include('eys.photo-techniques._form', [
            'photoTechnique' => new App\Models\PhotoTechnique,
            'locales' => $locales,
        ])
