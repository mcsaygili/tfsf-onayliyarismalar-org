<x-eys.app-layout :title="__('eys.education_level.new')">
    <div class="ip-page-actions" style="justify-content: space-between;">
        <x-eys.breadcrumb :crumbs="[
            ...
            ['label' => __('eys.education_level.new')],
        ]" />
    ...
    <form method="POST" action="{{ route('eys.education-levels.store') }}" novalidate autocomplete="off">
        @csrf

        @include('eys.education-levels._form', [
            'educationLevel' => new App\Models\EducationLevel,
            'locales' => $locales,
        ])
