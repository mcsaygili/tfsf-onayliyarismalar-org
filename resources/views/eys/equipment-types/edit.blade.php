<x-eys.app-layout :title="__('eys.equipment_type.edit_title')">
    <div class="ip-page-actions" style="justify-content: space-between;">
        <x-eys.breadcrumb :crumbs="[
            ...
            ['label' => __('eys.equipment_type.edit_title')],
        ]" />
    ...
    <form method="POST" action="{{ route('eys.equipment-types.update', $equipmentType) }}" novalidate autocomplete="off">
        @csrf
        @method('PATCH')
