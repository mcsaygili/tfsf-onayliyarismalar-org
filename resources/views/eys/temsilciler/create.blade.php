<x-eys.app-layout :title="__('eys.temsilci.new')">
    ...
    <div class="ip-card">
        <div class="ip-section-title">{{ __('eys.temsilci.new') }}</div>

        <form method="POST" action="{{ route('eys.temsilciler.store') }}" novalidate autocomplete="off">
            @csrf
            ...
            <div class="ip-grid-2">
                <div class="ia-field">
                    <x-eys.label for="password" :value="__('eys.temsilci.password')" />
                ...
                <div class="ia-field" style="margin-bottom: 0;">
                    <x-eys.label for="password_confirmation" :value="__('eys.temsilci.password_confirmation')" />
